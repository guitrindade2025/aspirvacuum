      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {/* Added industrial system services and benefits based on the client's requirements. */}
            <div className="bg-white rounded-lg shadow-md p-6 mb-12">
              <h2 className="text-2xl font-bold mb-4">Serviços Industriais</h2>
              <p className="text-gray-600 mb-4">Soluções robustas para sistemas de aspiração central em ambientes industriais.</p>
              <ul className="list-disc list-inside text-gray-600">
                <li>Manutenção preventiva e corretiva</li>
                <li>Substituição de componentes industriais</li>
                <li>Instalação de sistemas de alta capacidade</li>
              </ul>
              <p className="text-gray-600 mt-4">Garantimos segurança e eficiência em todos os serviços realizados.</p>
            </div>
